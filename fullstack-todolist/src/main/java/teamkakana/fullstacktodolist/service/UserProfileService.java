...
import teamkakana.fullstacktodolist.repository.UserProfileDataAccessService;
import teamkakana.fullstacktodolist.util.FileStoreUtil;
...
public class UserProfileService {
    ...
    public void uploadUserProfileImage(UUID userProfileId, MultipartFile file) {
        ...
        String path = String.format("%s/%s", "wd12p", user.getUserProfileId());
